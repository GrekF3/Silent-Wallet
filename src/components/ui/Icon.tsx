...
export const Icons = {
  ...
  help:       i(<><circle cx="12" cy="12" r="10"/><path d="M9.6 9.2a2.7 2.7 0 015.1 1.2c0 1.9-2.7 2.1-2.7 4"/><line x1="12" y1="17.3" x2="12.01" y2="17.3"/></>),
  ...
  filter:     i(<><path d="M3 5h18"/><path d="M7 12h10"/><path d="M10 19h4"/></>),
  sort:       i(<><path d="M7 4v16"/><path d="M3 8l4-4 4 4"/><path d="M17 20V4"/><path d="M13 16l4 4 4-4"/></>),
  coins:      i(<><ellipse cx="12" cy="5" rx="7" ry="3"/><path d="M5 5v5c0 1.7 3.1 3 7 3s7-1.3 7-3V5"/><path d="M5 10v5c0 1.7 3.1 3 7 3s7-1.3 7-3v-5"/></>),
